...
## Project Structure
    ...
    ├── testapiautoteammemb_71437  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_71437`
...
2. Clone this repo and `cd testapiautoteammemb_71437`
